"""
Django settings for projectomerta project.
"""
import os
...
SECRET_KEY = 'django-insecure-3(sbph3_(y$-n-uczo@w62g))y24w!3kjx(=kf!s#q4%$#i)+('
...
ROOT_URLCONF = 'projectomerta.urls'
...
WSGI_APPLICATION = 'projectomerta.wsgi.application'
